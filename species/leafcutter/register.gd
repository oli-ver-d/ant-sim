...
func register(registry: Registry) -> void:
	...
	registry.register_behaviour("carry_down", CarryDownBehaviour.new())
	registry.register_behaviour("garden", GardenBehaviour.new())
	...
	registry.register_item_type("gongylidia", Item)
